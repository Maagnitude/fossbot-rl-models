...
try:
    while True:
        model.learn(total_timesteps=10000, reset_num_timesteps=False, tb_log_name="TRPO_1")  # Perform a training iteration
        ...
        file_path = os.path.join("records", "trpo_records_3.txt")
