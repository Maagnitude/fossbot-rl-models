...
# ax.plot(steps[steps <= 115], dqn_rewards[steps <= 115], label='DQN Reward', linestyle='--', linewidth=2)

# # Plot PPO rewards up to step 65
# ax.plot(steps[steps <= 115], ppo_rewards[steps <= 115], label='PPO Reward', linestyle='-', linewidth=2)

# # Set labels and title
# plt.xlabel('Evaluation Cycles (x10 Episodes)')
# plt.ylabel('Average Reward')
# plt.title('DQN vs PPO Training Results')
# plt.legend()
# plt.grid(True)
