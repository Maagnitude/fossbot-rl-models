...
logdir = "logs"
model_name = "qr_dqn_gridworld_15x15"
...
try:
    while True:
        model.learn(total_timesteps=10000, reset_num_timesteps=False, tb_log_name="QRDQN_1")  # Perform a training iteration
        ...
        file_path = os.path.join("records", "qr_dqn_records.txt")
