...
# 15x15
# model_name = "trpo_gridworld_15x15"

# 30x30
model_name = "trpo_gridworld_30x30"
...
try:
    while True:
        model.learn(total_timesteps=10000, reset_num_timesteps=False, tb_log_name="TRPO_2")  # Perform a training iteration
        ...
        file_path = os.path.join("records", "trpo_records_30x30.txt")
